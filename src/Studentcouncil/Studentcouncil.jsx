    ...
    <div id="Teams">
      ...
      >
        ...
        <div className="subTeam">
          ...
          <div className="subTeamMember1">
            <Profilecard img="/web-assets/img/tp.jpg" name="Shreyash Shinde" insta="https://www.instagram.com/" position="Jt. Sports Secretary" linked="#" />
          </div>
          <div className="subTeamMember1">
      ...
      >
        ...
        <div className="subTeam">
          ...
          <div className="subTeamMember1">
            <Profilecard img="/web-assets/img/tp.jpg" name="Chinmayee Sawant" insta="https://www.instagram.com//" position="ITSA President" linked="#" />
          </div>
          <div className="subTeamMember1">
      ...
      >
        <div className="TeamMember1">
          <Profilecard img="/ss-assets/sachin1.png" name="Sachin Rathod" insta="https://www.instagram.com/sachinrathod_125/" position="Technical Team Head" linked="https://www.linkedin.com/in/rs-rathodsachin/" />
        </div>
        ...
        <div className="subTeam">
          ...
          <div className="subTeamMember1">
            <Profilecard img="/web-assets/img/tp.jpg" name="Sumedh Inamdar" insta="https://www.instagram.com//" position="Photography Team Head" linked="#" />
          </div>
          <div className="subTeamMember1">
      ...
      >
        <div className="TeamMember1">
          <Profilecard img="/web-assets/img/tp.jpg" name="Dheeraj Gupta" position="NCC Representative" insta="https://www.instagram.com/" />
        ...
        <div className="subTeamMember1">
            <Profilecard img="/ss-assets/shrushti.jpg" name="Shrushti Nikam" position="Ladies Representative (Open)" insta="https://www.instagram.com/shrushtii_nikam/" />

          </div>
          <div className="subTeamMember1">
            <Profilecard img="/ss-assets/nupur.jpg" name="Nupur Naik" position="NSS Representative" insta="https://www.instagram.com/_nupurnaik_/" />

          </div>
          <div className="subTeamMember1">
            <Profilecard img="/ss-assets/anjali.jpg" name="Anjali Bansode" position="Ladies Representative (Reserved)" insta="https://www.instagram.com/__.anjalii_._/" />
