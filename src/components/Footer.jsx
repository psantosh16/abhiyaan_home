...
const Footer = () => {
  const Icons = [
    {
      class: "transition duration-400 ease-in-out  fa-brands fa-instagram text-3xl md:text-5xl hover:scale-110 ",
      id: 1,
    ...
    {
      class: "transition duration-400 ease-in-out  fa-brands fa-youtube text-3xl md:text-5xl  hover:scale-110",
      id: 3,
    ...
    {
      class: "transition duration-400 ease-in-out  fa-brands fa-linkedin text-3xl md:text-5xl  hover:scale-110",
      id: 5,
      link: "https://www.linkedin.com/school/bharati-vidyapeeth-college-of-engineering-navi-mumbai/",
    },
    {
      class: "transition duration-400 ease-in-out  fa-brands fa-telegram text-3xl md:text-5xl  hover:scale-110",
      id: 6,
